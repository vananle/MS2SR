...
def get_args():
    ...
    # Wavenet
    parser.add_argument('--seq_len_x', type=int, default=36, choices=[6, 12, 24, 36, 48, 60, 72],
                        help='input length default 64')
    parser.add_argument('--seq_len_y', type=int, default=36, choices=[6, 12, 24, 36, 48, 60, 72],
